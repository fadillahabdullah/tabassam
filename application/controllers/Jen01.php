...
class Jen01 extends CI_Controller {
	public $idsc;
	public $aksesc = array();
	...
	public function tambah(){
		if($this->aksesc[0] == "1"){
			...
			$operasi = $this->Mjen01->tambah($id, $nama, $keterangan);
			if($operasi == "1"){
				$ket = "ID jenis: $id,\nNama jenis: $nama,\nStatus: $keterangan";
	...
	public function update(){
		if($this->aksesc[1] == "1"){
			...
			$nama = trim(str_replace("'","''",$this->input->post("nama")));
			$keterangan = trim(str_replace("'","''",$this->input->post("keterangan")));
			$operasi = $this->Mjen01->update($id, $nama, $keterangan);
			if($operasi == "1"){
				$ket = "ID jenis: $id,\nNama jenis: $nama,\nID Jenis: $keterangan";
