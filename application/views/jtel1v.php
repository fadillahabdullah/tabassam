<div class="page-header">
	<h1 class="page-title">Input Jenis Telur Breeding Farm</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                    <div class="form-group col-md-12">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtid" placeholder="Masukkan Kode jenis telur" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Nama*</label>
						<input type="text" class="form-control jedaobyek" id="txtnama" placeholder="Masukkan Nama jenis telur" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Keterangan*</label>
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtket" placeholder="ket" autocomplete="off">
					</div>
...
<script>
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data jenis telur Berhasil di Tambahkan',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
            ...
            success: function(x){
                ...
                if(y == 1){
                    swal({
						...
						text: 'Data jenis telur Berhasil di Update',
						icon: 'success'
					}).then((Refreshh)=>{
						refresh();
						tabel.ajax.reload(null, false);
	...
	function hapus(){
        ...
        if(id == ""){
            swal({title: 'Hapus Gagal', text: 'ID jenis telur Kosong !', icon: 'error'});
            return;
		}
		swal("Memproses Data.....", {button: false, closeOnClickOutside: false, closeOnEsc: false});
		swal({
					...
					success: function(x){
						...
						if(y == 1){
							swal({
								...
								text: 'Data jenis telur Berhasil di Hapus',
								icon: 'success'
							}).then((Refreshh)=>{
								refresh();
								tabel.ajax.reload(null, false);
							...
							if(y == 99){
								...
								if(y == 90){
									swal({title: 'Hapus Gagal', text: 'Data jenis telur Ini Masih digunakan dalam Data Form jenis telur, Sehingga Tidak Dapat di Hapus Hanya Dapat di Ubah', icon: 'error'});
									refresh();
								}else{
