<div class="page-header">
	<h1 class="page-title">Input Cooling Room Dailty Check</h1>
			...
			<div class="panel-body">
				<div class="form-row">
                    <div class="form-group col-md-12">
						...
						<input type="text" class="form-control khusus_abjad jedaobyek" id="txtid" placeholder="Masukkan Kode Cooling Room" autocomplete="off">
					</div>
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control  jedaobyek" id="txtrh" placeholder="1200" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
...
<script>
	...
	function tambah(){
        ...
        var tgl = $("#txtdate").val();
        var jam = $("#txtjam").val();
        var tspoint = $("#txtspoint").val();
        var tactual = $("#txtactual").val();
        var rh = $("#txtrh").val();
        var keterangan = $("#txtket").val();
    
        if(id == "" || tgl == "" || jam == "" || tspoint == "" || tactual == ""|| rh == "" || keterangan == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, tgl: tgl, jam: jam, tspoint: tspoint, tactual: tactual, rh: rh, keterangan: keterangan},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
