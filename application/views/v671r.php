            ...
            <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
                <div class="panel">
                    <div class="panel-body">
                        <div class="brand">
                            <img class="rounded-circle" src="<?= base_url('assets/images/tbs.png'); ?>" alt="..." style="width: 35%">
                            <h2 class="brand-text font-size-18">Sistem Informasi<br>PT Tabassam Jaya Farm<br>Terintegrasi</h2>
                        </div>
