<div class="page-header">
	<h1 class="page-title">Input Jenis Pakan Breeding Farm</h1>
			...
			<div class="panel-body">
				<div class="form-row">
					...
					<div class="form-group col-md-12 jedaobyek">
						...
						<input type="text" class="form-control jedaobyek" id="txtnama" placeholder="Masukkan Nama Pakan" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
