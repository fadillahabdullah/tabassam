...
<html class="no-js css-menubar" lang="en">
    <head>
        ...
        <title>Dashboard | Breeding Farm System</title>
        <!-- CORE -->
    ...
    <body class="animsition site-navbar-small dashboard">
        <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-center" href="basis.php">
                    <img class="navbar-brand-logo navbar-brand-logo-normal rounded-circle" src="<?= base_url('assets/images/tbs.png'); ?>" title="Breeding Farm System">
                    <img class="navbar-brand-logo navbar-brand-logo-special rounded-circle" src="<?= base_url('assets/images/tbs.png'); ?>" title="Breeding Farm System">
                    <span class="navbar-brand-text hidden-xs-down"> Breeding Farm System</span>
                </a>
            </div>
        ...
        <footer class="site-footer">
            <div class="site-footer-legal">© 2021 <a href="javascript:void(0)">Breeding Farm System</a></div>
