...
<html class="no-js css-menubar" lang="en">
    <head>
        ...
        <title>Dashboard | Zuffar System</title>
        <!-- CORE -->
    ...
    <body class="animsition site-navbar-small dashboard">
        <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-center" href="index.html">
                    <img class="navbar-brand-logo navbar-brand-logo-normal" src="<?= base_url('assets/images/tbs.png'); ?>" title="Zuffar System">
                    <img class="navbar-brand-logo navbar-brand-logo-special" src="<?= base_url('assets/images/tbs.png'); ?>" title="Zuffar System">
                    <span class="navbar-brand-text hidden-xs-down"> Zuffar System</span>
                </a>
            </div>
        ...
        <footer class="site-footer">
            <div class="site-footer-legal">© 2021 <a href="javascript:void(0)">Zuffar System</a></div>
