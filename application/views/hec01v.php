<div class="page-header">
	<h1 class="page-title">Input Hatcher Dailty Check</h1>
		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="form-row">
					...
					<div class="form-group col-md-12 jedaobyek">
						<label class="form-control-label">Heater*</label>
						<input type="text" class="form-control  jedaobyek" id="txtheater" placeholder="1200" autocomplete="off">
					</div>
					<div class="form-group col-md-12 jedaobyek">
...
<script>
	...
	function tambah(){
        ...
        var heater = $("#txtheater").val();
        var damper = $("#txtdamper").val();        
        var spray = $("#txtspray").val();
        var tnight = $("#txttnight").val();
    
        if(id == "" || tgl == "" || jam == "" || tpoin == "" || tactual == "" || hpoin == "" || hactual == "" || heater == "" || damper == "" || spray == "" || tnight == ""){
        ...
        $.ajax({
            ...
            method: "POST",
            data: {id: id, tgl: tgl, jam: jam, tpoin: tpoin, tactual: tactual, hpoin: hpoin, hactual: hactual, heater: heater, damper: damper, spray: spray, tnight: tnight},
            cache: "false",
            success: function(x){
				swal.close();
				var y = atob(x);
