...
<html class="no-js css-menubar" lang="en">
    <head>
        ...
        <meta name="description" content="Sistem Informasi PT TJF Jaya Farm Terintegrasi">
        <meta name="author" content="Mojosari Kab. Mojokerto">
        <title>Dashboard | TJF System</title>
        <link rel="apple-touch-icon" href="<?= base_url('assets/images/apple-touch-icon.png'); ?>">
        <link rel="shortcut icon" href="<?= base_url('assets/images/tbs.png'); ?>">
    ...
    <body class="animsition site-navbar-small dashboard">
        <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-inverse" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-center" href="<?= base_url('Dashboard'); ?>">
                    <img class="navbar-brand-logo navbar-brand-logo-normal rounded-circle" src="<?= base_url('assets/images/tbs.png'); ?>" title="TJF System">
                    <img class="navbar-brand-logo navbar-brand-logo-special rounded-circle" src="<?= base_url('assets/images/tbs.png'); ?>" title="TJF System">
                    <span class="navbar-brand-text hidden-xs-down"> TJF System</span>
                </a>
            </div>
                    ...
                    ?>
                                    <div class="col-md-3">
                                        <div class="card card-block <?= $bg; ?>" data-linksistem="<?= base_url($idsistem.'/Dashboard'); ?>" onclick="ke(this)" style="cursor: pointer">
                                            <blockquote class="blockquote cover-quote card-blockquote" style="color: white; font-size: 27px">
                                                <p><?= $nmsistem; ?></p>
                                                <footer style="font-size: 20px;">
                                                    <small><?= $desksistem; ?></small>
                                                </footer>
                                            </blockquote>
                                        </div>
                                    </div>
        ...
        <footer class="site-footer">
            <div class="site-footer-legal">© 2021 <a href="javascript:void(0)">TJF System</a></div>
            <div class="site-footer-right">
                Crafted with <i class="red-600 wb wb-heart"></i> by <a href="javascript:void(0)">KafaSoft</a>
            </div>
        </footer>
        ...
        <script src="<?= base_url('global/vendor/slidepanel/jquery-slidePanel.js'); ?>"></script>
            <!-- <script src="<?= base_url('global/vendor/chartist/chartist.js'); ?>"></script> -->
            <script src="<?= base_url('global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.js'); ?>"></script>
            <!-- <script src="<?= base_url('global/vendor/aspieprogress/jquery-asPieProgress.js'); ?>"></script> -->
            <script src="<?= base_url('global/vendor/matchheight/jquery.matchHeight-min.js'); ?>"></script>
            <script src="<?= base_url('global/vendor/jquery-selective/jquery-selective.min.js'); ?>"></script>
            <!-- <script src="<?= base_url('global/vendor/bootstrap-datepicker/bootstrap-datepicker.js'); ?>"></script> -->
